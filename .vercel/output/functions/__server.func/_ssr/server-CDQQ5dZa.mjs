...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CKKOw37X.mjs");
...
const manifest = {
  "089a630ec02fc66e53ceabc14910eccb3c610550b8fa42bc9e99345b98106346": {
    functionName: "ensureAdminSeeded_createServerFn_handler",
    importer: () => import("./admin.functions-ZTe2sUQo.mjs")
  },
  "5f15d9c6194c3264109b1c81741c60a8654b66a5caffc1ee319315a3a983394e": {
    functionName: "deleteUser_createServerFn_handler",
    importer: () => import("./admin.functions-ZTe2sUQo.mjs")
  },
  "80e0e022f8c7a4ba7e1543f04829927225ac27fbb1fdd1e972900498e87163bf": {
    functionName: "resetUserPin_createServerFn_handler",
    importer: () => import("./admin.functions-ZTe2sUQo.mjs")
  },
  "8a5ab6eb44ff34933514cd80eaebb5275eb142a889e28cbb625bede6478204b6": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-yzFmt3hU.mjs").then((n) => n.r),
    import("./start-CutpTW1W.mjs"),
