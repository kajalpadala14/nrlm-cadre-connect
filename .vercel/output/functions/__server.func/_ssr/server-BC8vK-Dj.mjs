...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-XautpHl-.mjs");
...
const manifest = {
  "089a630ec02fc66e53ceabc14910eccb3c610550b8fa42bc9e99345b98106346": {
    ...
    importer: () => import("./admin.functions-BYAU2-Hc.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D5xsBJge.mjs").then((n) => n.r),
    import("./start-YkSUiidC.mjs"),
